!function (e, t) {
  ...
  return function (e) {
    ...
    function o(e, t, n) {
      "user strict";
      var o = "", a = 0, s = !1, l = !1, c = 0, u = e.length, d = "", p = "";
      for (c = 0; c < u; c++) {
        var f = e.charAt(c);
        if (!1 === s) {
          if ("<" === f) {
          ...
          if (">" === f) {
            o += n(e.slice(a, s)), p = e.slice(s, c + 1), d = r(p), o += t(s, o.length, d, p, i(p)), a = c + 1, s = !1;
            continue
          }
          if (('"' === f || "'" === f) && "=" === e.charAt(c - 1)) {
            l = f;
    ...
    function a(e, t) {
      ...
      for (var r = 0, i = [], o = !1, a = e.length, c = 0; c < a; c++) {
        ...
        if (!1 !== o || "=" !== g) if (!1 === o || c !== r || '"' !== g && "'" !== g || "=" !== e.charAt(c - 1)) if (/\s|\n|\t/.test(g)) {
          ...
          if (-1 === (h = l(e, c - 1))) {
            f = d.trim(e.slice(r, c)), f = u(f), n(o, f), o = !1, r = c + 1;
            continue
          }
        } else ; else {
          if (-1 === (h = e.indexOf(g, c + 1))) break;
          f = d.trim(e.slice(r + 1, h)), n(o, f), o = !1, c = h, r = c + 1
        } else o = e.slice(r, c), r = c + 1
      }
      return r < e.length && (!1 === o ? n(e.slice(r)) : n(o, u(d.trim(e.slice(r))))), d.trim(i.join(" "))
    }
    ...
    function o(e) {
      return e && E.test(e) ? e.replace(M, function (e) {
        return T[e]
      }) : e
    }

    function a(e) {
      return e && q.test(e) ? e.replace(I, function (e) {
        return C[e]
      }) : e
    }
    ...
    }(), l = n(9), c = r(l), u = n(10), d = r(u), p = n(7), f = r(p), h = n(8), g = r(h), v = n(11), m = function (e) {
    ...
    var y = {comment: "", nick: "Anonymous", mail: "", link: "", ua: navigator.userAgent, url: ""}, k = {
        "zh-cn": {
      ...
      }, w = [{name: "point_up", code: "261D"}, {name: "fist", code: "270A"}, {name: "hand", code: "270B"}, {
        name: "eyes",
        code: "1F440"
      }, {name: "ear", code: "1F442"}, {name: "nose", code: "1F443"}, {name: "lips", code: "1F444"}, {
        name: "tongue",
        code: "1F445"
      }, {name: "point_up_2", code: "1F446"}, {name: "point_down", code: "1F447"}, {
        name: "point_left",
        code: "1F448"
      }, {name: "point_right", code: "1F449"}, {name: "facepunch", code: "1F44A"}, {
        name: "wave",
        code: "1F44B"
      }, {name: "ok_hand", code: "1F44C"}, {name: "+1", code: "1F44D"}, {name: "-1", code: "1F44E"}, {
        name: "clap",
        code: "1F44F"
      }, {name: "cupid", code: "1F498"}, {name: "sparkling_heart", code: "1F496"}, {
        name: "open_hands",
        code: "1F450"
      }, {name: "grinning", code: "1F600"}, {name: "grin", code: "1F601"}, {name: "joy", code: "1F602"}, {
        name: "smiley",
        code: "1F603"
      }, {name: "smile", code: "1F604"}, {name: "sweat_smile", code: "1F605"}, {
        name: "laughing",
        code: "1F606"
      }, {name: "innocent", code: "1F607"}, {name: "smiling_imp", code: "1F608"}, {
        name: "wink",
        code: "1F609"
      }, {name: "blush", code: "1F60A"}, {name: "yum", code: "1F60B"}, {
        name: "relieved",
        code: "1F60C"
      }, {name: "heart_eyes", code: "1F60D"}, {name: "sunglasses", code: "1F60E"}, {
        name: "smirk",
        code: "1F60F"
      }, {name: "neutral_face", code: "1F610"}, {name: "expressionless", code: "1F611"}, {
        name: "unamused",
        code: "1F612"
      }, {name: "sweat", code: "1F613"}, {name: "pensive", code: "1F614"}, {
        name: "confused",
        code: "1F615"
      }, {name: "confounded", code: "1F616"}, {name: "kissing", code: "1F617"}, {
        name: "kissing_heart",
        code: "1F618"
        ...
        code: "1F61C"
      }, {name: "stuck_out_tongue_closed_eyes", code: "1F61D"}, {name: "disappointed", code: "1F61E"}, {
        name: "worried",
        code: "1F61F"
      }, {name: "angry", code: "1F620"}, {name: "rage", code: "1F621"}, {name: "cry", code: "1F622"}, {
        name: "persevere",
        code: "1F623"
      }, {name: "triumph", code: "1F624"}, {name: "disappointed_relieved", code: "1F625"}, {
        name: "frowning",
        code: "1F626"
      }, {name: "anguished", code: "1F627"}, {name: "fearful", code: "1F628"}, {
        name: "weary",
        code: "1F629"
      }, {name: "sleepy", code: "1F62A"}, {name: "tired_face", code: "1F62B"}, {
        name: "grimacing",
        code: "1F62C"
      }, {name: "sob", code: "1F62D"}, {name: "open_mouth", code: "1F62E"}, {
        name: "hushed",
        code: "1F62F"
      }, {name: "cold_sweat", code: "1F630"}, {name: "scream", code: "1F631"}, {
        name: "astonished",
        code: "1F632"
      }, {name: "flushed", code: "1F633"}, {name: "sleeping", code: "1F634"}, {
        name: "dizzy_face",
        code: "1F635"
      }, {name: "no_mouth", code: "1F636"}, {name: "mask", code: "1F637"}, {name: "pray", code: "1F64F"}], S = {
        cdn: "https://gravatar.loli.net/avatar/",
        ds: ["mm", "identicon", "monsterid", "wavatar", "retro", ""],
        params: "",
        hide: !1
      }, A = ["nick", "mail", "link"], O = !1,
      $ = Storage && localStorage && localStorage instanceof Storage && localStorage,
      _ = location.pathname.replace(/index\.(html|htm)$/, ""), F = function () {
        function e(t) {
          i(this, e);
          var n = this;
          return !!t && n.init(t), n
        ...
        return s(e, [{
          key: "init", value: function (e) {
            var t = this;
            try {
              var n = e.lang || "", r = e.langMode || "", i = S.ds, o = e.avatar || "mm", a = e.avatar_cdn || "";
              n && r && t.installLocale(n, r), t.locale = t.locale || k[e.lang || "zh-cn"], t.notify = e.notify || !1, t.verify = e.verify || !1, S.params = "?d=" + (i.indexOf(o) > -1 ? o : "mm"), S.hide = "hide" === o, a && (S.cdn = a), _ = e.path || _, e.guest_info = (e.guest_info || A).filter(function (e) {
              ...
              if (e.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s, !O) {
                ...
                var c = e.app_id || e.appId, u = e.app_key || e.appKey, d = (e.region || "cn").toLowerCase(),
                  p = ["cn", "us"];
                if (d = p.indexOf(d) > -1 ? d : p[0], !c || !u) throw 100;
                l.init({appId: c, appKey: u, region: d}), O = !0, t.v = l;
                for (var f = document.querySelectorAll(".valine-comment-count"), h = 0, g = f.length; h < g; h++) !function (e, n) {
                  var r = f[e];
                  if (r) {
              ...
              var v = e.el || null, m = document.querySelectorAll(v);
              ...
              $.setAttribute("class", "vloading"), $.innerHTML = '<div class="loading loading--double"></div>';
              var F = t.el.querySelector(".vlist");
              t.loading = {
                show: function (e) {
                  var n = F.querySelectorAll("li");
                  return e ? F.insertBefore($, n[0]) : F.appendChild($), t.nodata.hide(), t
                }, hide: function () {
                  var e = F.querySelector(".vloading");
                  return e && F.removeChild(e), 0 === F.querySelectorAll(".vcard").length && t.nodata.show(), t
                }
              };
              ...
              t.alert = {
                show: function (e) {
                  ...
                  if (n.innerHTML = "" + r + (e && e.type && i), B.on("click", C.querySelector(".vcancel"), function (e) {
                    t.alert.hide()
          ...
          key: "Q", value: function (e) {
            var t = this, n = new t.v.Query("Comment");
            return n.equalTo("url", decodeURI(e)), n.addDescending("createdAt"), n.addDescending("insertedAt"), n
          }
        }, {
          ...
          key: "installLocale", value: function (e, t) {
            var n = this;
            return t = t || {}, k[e] = JSON.stringify(Object.keys(k["zh-cn"])) == JSON.stringify(Object.keys(t)) ? t : void 0, n.locale = k[e] || k["zh-cn"], n
          }
        }, {
          ...
          key: "bind", value: function (e) {
            for (var t = this, n = t.el.querySelector(".vemojis"), r = t.el.querySelector(".vemoji-btn"), i = t.el.querySelector(".vpreview"), s = function (e) {
              var n = "comment", r = e.value || "", o = r.substring(0, 1e4);
              t.el.querySelector(".vlimit").innerHTML = "" == r ? "" : t.locale.tips.limit.replace("%d", 1e4 - o.length), y[n] = x.process((0, d.default)(o)), i.innerHTML = y[n], e.value = o
            }, l = String.fromCharCode, u = Math.floor, p = function () {
              var e, t, n = [], r = -1, i = arguments.length;
              if (!i) return "";
              for (var o = ""; ++r < i;) {
                var a = Number(arguments[r]);
                if (!isFinite(a) || a < 0 || a > 1114111 || u(a) != a) throw RangeError("Invalid code point: " + a);
                a <= 65535 ? n.push(a) : (a -= 65536, e = 55296 + (a >> 10), t = a % 1024 + 56320, n.push(e, t)), (r + 1 == i || n.length > 16384) && (o += l.apply(null, n), n.length = 0)
              }
              return o
            }, h = 0, v = w.length; h < v; h++) !function (e, t) {
              var r = w[e], i = r.code.split("-").map(function (e, t) {
                return parseInt(e, 16)
              }), o = p(i), a = document.createElement("i");
              a.setAttribute("name", r.name), a.innerHTML = o, B.on("click", a, function (e) {
            ...
            for (var m = e.guest_info, b = {}, k = {veditor: "comment"}, h = 0, v = m.length; h < v; h++) k["v" + m[h]] = m[h];
            for (var A in k) k.hasOwnProperty(A) && function () {
              var e = k[A], n = t.el.querySelector("." + A);
              b[e] = n, B.on("input", n, function (t) {
            ...
            var F = function (e, t) {
              ...
              var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1, i = e.pageSize,
                o = Number(t.el.querySelector(".vnum").innerText);
              t.loading.show();
              var a = t.Q(_);
              a.limit(i), a.skip((r - 1) * i), a.find().then(function (e) {
                for (var a = e.length, s = 0; s < a; s++) T(e[s], !0);
            ...
            var T = function (e, n) {
              ...
              var i = S.hide ? "" : '<img class="vimg" src=\'' + (S.cdn + (0, c.default)(e.get("mail")) + S.params) + "'>",
                o = (0, f.default)(e.get("ua")), a = '<span class="vsys">' + o.browser + " " + o.version + "</span>",
                s = '<span class="vsys">' + o.os + " " + o.osVersion + "</span>", l = "", u = e.get("link") || "";
              l = u ? '<a class="vname" rel="nofollow" href="' + u + '" target="_blank" >' + e.get("nick") + "</a>" : '<span class="vname">' + e.get("nick") + "</span>", r.innerHTML = i + '<section><div class="vhead">' + l + " " + a + " " + s + '</div><div class="vcontent">' + e.get("comment") + '</div><div class="vfooter"><span class="vtime">' + (0, g.default)(e.get("createdAt"), t.locale) + "</span><span rid='" + e.id + "' at='@" + e.get("nick") + "' mail='" + e.get("mail") + '\' class="vat">' + t.locale.ctrl.reply + "</span><div></section>";
              ...
              var b = t.el.querySelector(".vlist"), x = b.querySelectorAll("li");
              n ? b.appendChild(r) : b.insertBefore(r, x[0]);
              var y = r.querySelector(".vcontent");
              y && L(y), d && E(d)
            }, L = function (e) {
              setTimeout(function () {
                e.offsetHeight > 180 && (e.classList.add("expand"), B.on("click", e, function (t) {
                  e.setAttribute("class", "vcontent")
                }))
              }, 20)
            }, M = {at: "", rid: "", rmail: ""}, E = function (e) {
              B.on("click", e, function (t) {
                var n = e.getAttribute("at"), r = e.getAttribute("rid"), i = e.getAttribute("mail");
                M.at = o(n), M.rid = r, M.rmail = i, b.comment.value = n + " ", b.comment.focus()
              })
            }, I = function () {
              var e = $ && $.ValineCache;
              if (e) {
                ...
                for (var r in n) {
                  var i = n[r];
                  t.el.querySelector(".v" + i).value = a(e[i]), y[i] = e[i]
                }
              }
            };
            I();
            var q = function () {
              for (var e in k) if (k.hasOwnProperty(e)) {
                var n = k[e], r = t.el.querySelector("." + e);
                r.value = "", y[n] = ""
              }
              M.at = "", M.rid = "", M.rmail = "", y.nick = "Anonymous", t.el.querySelector(".vlimit").innerHTML = "", I()
            }, j = t.el.querySelector(".vsubmit"), P = function (e) {
              ...
              var r = z.mail(y.mail), i = z.link(y.link);
              y.mail = r.k ? r.v : "", y.link = i.k ? i.v : "", t.notify || t.verify ? Q(U) : U()
            }, R = function () {
              var e = new t.v.ACL;
              ...
              n.setACL(R()), n.save().then(function (e) {
                "Guest" != y.nick && $ && $.setItem("ValineCache", JSON.stringify({
                  nick: y.nick,
                  link: y.link,
                  mail: y.mail
                }));
                var n = t.el.querySelector(".vnum"), r = 1;
                try {
                  n ? (r = Number(n.innerText) + 1, n.innerText = r) : t.el.querySelector(".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments, T(e), y.mail && W({
                    username: y.nick,
                    mail: y.mail
                  }), M.at && M.rmail && t.notify && D({
                    username: M.at.replace("@", ""),
                    mail: M.rmail
                  }), j.removeAttribute("disabled"), t.loading.hide(), q()
                } catch (e) {
              ...
              t.alert.show({
                type: 1, text: u, ctxt: t.locale.ctrl.cancel, otxt: t.locale.ctrl.ok, cb: function () {
              ...
              var n = new t.v.User;
              return n.setUsername(e.username), n.setPassword(e.mail), n.setEmail(e.mail), n.setACL(R()), n.signUp()
            }, D = function e(n) {
            ...
            B.off("click", j, P), B.on("click", j, P), B.on("keyup", document, function (e) {
    ...
    var M = /[&<>"'`\\]/g, E = RegExp(M.source), I = /&(?:amp|lt|gt|quot|#39|#x60|#x5c);/g, q = RegExp(I.source), B = {
      on: function (e, t, n, r) {
    ...
    function r(e) {
      ...
      n.device = "PC", n.language = function () {
        var e = a.browserLanguage || a.language, t = e.split("-");
    ...
    var r = function (e, t) {
      if (e) try {
        ...
        if (0 === a) {
          ...
          if (0 === l) {
            var c = s % 36e5, u = Math.floor(c / 6e4);
            if (0 === u) {
              var d = c % 6e4;
    ...
    (function (t) {
      (function () {
        ...
        d.bullet = /(?:[*+-]|\d+\.)/, d.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, d.item = s(d.item, "gm")(/bull/g, d.bullet)(), d.list = s(d.list)(/bull/g, d.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + d.def.source + ")")(), d.blockquote = s(d.blockquote)("def", d.def)(), d._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", d.html = s(d.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, d._tag)(), d.paragraph = s(d.paragraph)("hr", d.hr)("heading", d.heading)("lheading", d.lheading)("blockquote", d.blockquote)("tag", "<" + d._tag)("def", d.def)(), d.normal = c({}, d), d.gfm = c({}, d.normal, {
          ...
          for (var r, i, o, a, s, l, c, u, p, e = e.replace(/^ +$/gm, ""); e;) if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({type: "space"})), o = this.rules.code.exec(e)) e = e.substring(o[0].length), o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
            type: "code",
    ...
    var s = n(0).FilterCSS, l = n(4), c = n(5), u = c.parseTag, d = c.parseAttr, p = n(1);
    a.prototype.process = function (e) {
      ...
      var b = u(e, function (e, t, n, l, u) {
        var m = {sourcePosition: e, position: t, isClosing: u, isWhite: o.hasOwnProperty(n)}, b = a(n, l, m);
        if (!r(b)) return b;
        if (m.isWhite) {
          if (m.isClosing) return "</" + n + ">";
          var x = i(l), y = o[n], k = d(x.html, function (e, t) {
            var i = -1 !== p.indexOf(y, e), o = c(n, e, t, i);
            if (!r(o)) return o;
